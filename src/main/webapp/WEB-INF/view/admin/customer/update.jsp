...
<head>
    ...
    <title>Cập nhật khách hàng - Hệ thống POS</title>
...
<body class="sb-nav-fixed">
                        ...
                        <div class="col-md-8 col-lg-6 mx-auto">
                            <div class="card mb-4">
                                <div class="card-header bg-warning text-dark">
                                    <i class="fas fa-user-edit me-2"></i>Thông tin khách hàng #${customer.id}
                                </div>
                                <div class="card-body">
                                    ...
                                    <form:form action="/admin/customer/update" method="post" modelAttribute="customer" class="row g-3" acceptCharset="UTF-8">
                                        <!-- Customer ID (Hidden) -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form:input path="totalPayment" type="number" id="totalPaymentInput" cssClass="form-control" 
                                                       min="0" step="1000" oninput="updateCustomerLevel()" />
                                            <form:errors path="totalPayment" cssClass="invalid-feedback d-block" />
                                            <small class="form-text text-muted">Cập nhật tổng chi tiêu của khách hàng</small>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="alert alert-success" id="levelDisplay">
                                                ...
                                                <span id="levelText">
                                                    Cấp ${customer.level} - 
                                                    <c:choose>
                                                        <c:when test="${customer.level == 1}">Thành viên mới (0% giảm giá)</c:when>
                                                        <c:when test="${customer.level == 2}">Bạc (5% giảm giá)</c:when>
                                                        <c:when test="${customer.level == 3}">Vàng (10% giảm giá)</c:when>
                                                        <c:when test="${customer.level == 4}">Kim cương (15% giảm giá)</c:when>
                                                    </c:choose>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="alert alert-info mb-0">
                                                <small>
                                                    ...
                                                    <strong>Lưu ý:</strong> Cấp độ thành viên sẽ tự động cập nhật dựa trên tổng chi tiêu
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 mt-4">
                                            ...
                                            <a href="/admin/customer/${customer.id}" class="btn btn-info">
    ...
    <script>
        ...
        // Gọi hàm khi trang load để hiển thị level hiện tại
